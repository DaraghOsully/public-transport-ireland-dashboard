...
export default function App() {
  ...
  const latest = filtered.at(-1), modeValue = (r, mode) => mode === 'All Public Transport' ? r.value : (r.modes?.[mode] ?? 0), trend = latest && data ? yoyFor(data, latest.year, latest.week, selectedMode === 'All Public Transport' ? null : selectedMode) : null;
  ...
  const ytd = latest && data ? comparableYtd(data, data, latest.year) : null;
